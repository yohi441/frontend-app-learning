...
export default function CourseBreadcrumbs({
  ...
  return (
    <nav aria-label="breadcrumb" className="my-4 tw-breadcrumb-nav d-inline-block col-sm-10">
      <ol className="m-0 list-unstyled d-flex flex-nowrap align-items-center">
        <li className="col-auto p-0 m-0 list-unstyled">
          <Link
            className="flex-shrink-0 tw-text-primaryNavy"
